...
import pytest
from medgan_synthesizer.models import FrontierPayload, ExecutionStatus
from medgan_synthesizer.engine import FrontierDomainEngine
from medgan_synthesizer.agents import DistributionMatcherAgent, GradientPenaltyDiscriminatorAgent, MembershipInferenceDefenseAgent, MedGANCoordinator
from medgan_synthesizer.cli import main


def test_sub_agents():
    a1 = DistributionMatcherAgent()
    ...
    a2 = GradientPenaltyDiscriminatorAgent()
    ...
    a3 = MembershipInferenceDefenseAgent()
...
def test_coordinator():
    ...
    assert "Synthetic Data Generation Best Practices" in ans or "specifications" in ans
