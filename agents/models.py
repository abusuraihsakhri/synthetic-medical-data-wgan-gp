"""
Pydantic v2 schemas and data definitions for Synthetic Medical Data Wgan Gp.
...
class AgentAlert(BaseModel):
    ...
    standard_reference: str = "HIPAA Safe Harbor §164.514 / Google SecAgg Standards"
    timestamp: str = Field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
...
class ConsensusDossier(BaseModel):
    dossier_id: str
    system_slug: str = "synthetic-medical-data-wgan-gp"
    domain: str = "Privacy-Preserving Federated Healthcare & FHE"
    task_id: str
