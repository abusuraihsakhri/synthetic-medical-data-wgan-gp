...
**Synthetic Medical Data Wgan Gp** is an advanced analytical and computational platform implementing Wasserstein GAN with Gradient Penalty clinical table synthesizer with membership defense.
...
docker run -p 8000:8000 synthetic-medical-data-wgan-gp
```
